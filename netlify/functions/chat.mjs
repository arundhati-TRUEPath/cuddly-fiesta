...
## COUNTIES WE SERVE
We serve 26 Washington counties: Adams, Asotin, Benton, Chelan, Clark,
Columbia, Cowlitz, Douglas, Ferry, Franklin, Garfield, Grant, Island,
Kittitas, Klickitat, Lincoln, Okanogan, Pend Oreille, Pierce, San Juan,
Skagit, Snohomish, Spokane, Stevens, Walla Walla, Whatcom, Whitman, and
Yakima, plus parts of King County.
...
Jobs and career inquiries: https://www.careerpathservices.org/contact/
...
together in one place. We work with partner agencies there to serve youth
ages 16 to 24. Call 509-326-7520 and we'll connect you.
 
**WIOA Youth** (ages 14–24 with barriers to employment) — Specialized
youth employment readiness, career guidance, resume assistance, temporary
paid employment, job search assistance, internships, skills training,
certifications, on-the-job training, workshops, case management, and
financial literacy. Served in: Benton, Franklin, Spokane, Clark, Cowlitz,
and Wahkiakum counties. For other areas, visit:
https://worksource.my.site.com/worksourcewa/site-locator
 
### For Adults Receiving TANF or WorkFirst Benefits
**Commerce WorkFirst Program** — Employment readiness, career guidance,
resume assistance, temporary paid employment, employer support, and job
search assistance. Counties served: Spokane, Lincoln, Pend Oreille,
Stevens, Ferry, Okanogan, Whatcom, Central King, South King, and Pierce.
Contact: workfirst@careerpathservices.org
 
**Growing Personal Skills (GPS)** — A 16-week group program built around
discussion of real-life essentials and life skills, for WorkFirst/TANF
participants. Offered in Eastern, Central, and Northwestern Washington.
Contact: workfirst@careerpathservices.org
 
**Community Jobs** — For people receiving TANF through WorkFirst. Career
Path Services acts as the employer of record and places participants at a
nonprofit or public host site to build real work experience at no cost to
the host. IMPORTANT: participants generally cannot sign up directly — a
DSHS case manager makes the referral. If someone asks how to join, tell
them to ask their DSHS case worker about a WorkFirst/Community Jobs
referral, and that they can also call 509-326-7520 with questions.
[BLANK 2 — wage, duration, and current host-site counties.]
 
### For Adults Receiving Food Benefits
**Support for people receiving food benefits (BFET)** — Training, job
...
**ORIA Basic Food, Employment & Training** — For refugees and immigrants
receiving Basic Food (SNAP) who are not receiving TANF. Offers employment
readiness, career guidance, job search assistance, training services, case
management, job retention support, supportive financial services, and
resume assistance. Served in: Benton and Franklin counties.
Contact: workfirst@careerpathservices.org
 
**ORIA Food Assistance Program Employment & Training** — For qualified
immigrants receiving Washington's Food Assistance Program (FAP). Offers
employment readiness, career guidance, job search assistance, resume
assistance, and services for refugees and immigrants. Served in: Benton
and Franklin counties. Contact: workfirst@careerpathservices.org
 
### For Refugees and Immigrants (All Income Levels)
**ORIA LEP Employment Pathway** — For refugees, immigrants, and other
individuals with limited English proficiency. Offers employment readiness,
career guidance, job search assistance, and resume assistance. Served in:
Clark, Snohomish, and Spokane counties.
Contact: workfirst@careerpathservices.org
 
**ORIA LEP Pathway Workforce-Aligned Training Program** — For refugees and
immigrants with limited English proficiency seeking workforce training
combined with English language instruction. Offers industry-specific
training, employment readiness, and services for refugees and immigrants.
Served in: Clark, Snohomish, and Spokane counties.
Contact: workfirst@careerpathservices.org
 
### Career and Training Programs (Specific Industries)
**MediWork$** — A free 8-week training course for entry-level non-clinical
roles in healthcare. Non-clinical healthcare roles include Patient Services
Specialist, Call Center Representative, and Medical Billing Specialist.
Delivered in greater King County. Eligibility: high school diploma or
equivalent; 18 or older; basic computer skills; passing standard background
clearance; English proficiency (bilingual applicants encouraged).
[BLANK 3 — current cohort dates, class location, and application link.]
...
Spokane and Pierce counties. [BLANK 4 — eligibility, cohort dates, and
application link.]
 
**DOT PASS Pre-Apprenticeship** — For individuals interested in
apprenticeship and skilled trades careers, especially those facing barriers
to entering apprenticeship programs. Offers pre-apprenticeship program
focused on careers in skilled trades and highway construction, professional
development, and digital literacy. Served in: Benton and Franklin counties.
...
**Economic Security for All (EcSA)** — For individuals and families with
low incomes or barriers to economic self-sufficiency, with a focus on
underserved communities. Offers employment readiness, career guidance,
resume assistance, temporary paid employment, employer support, job search
assistance, paid work internships, skills training, certifications,
on-the-job training, workshops, case management, and financial literacy.
Served in: Benton, Franklin, and Spokane counties. For other areas:
https://worksource.my.site.com/worksourcewa/site-locator
 
**WIOA Adult** (age 18+) — For adults age 18 and older seeking employment
or training services, with priority for low-income individuals, public
assistance recipients, and those with basic skills needs. Offers employment
readiness, career guidance, resume assistance, paid employment opportunities,
employer support, job search assistance, internships, skills training,
certifications, on-the-job training, workshops, case management, and
financial literacy. Served in: Benton, Franklin, and Spokane counties.
For other areas: https://worksource.my.site.com/worksourcewa/site-locator
 
**WIOA Dislocated Worker** — For individuals who have lost their jobs due to
layoff, business closure, downsizing, or similar circumstances. Offers
employment readiness, career guidance, resume assistance, skills training,
certifications, on-the-job training, workshops, case management, employer
support, and financial literacy. Served in: Benton, Franklin, and Spokane
counties. For other areas: https://worksource.my.site.com/worksourcewa/site-locator
